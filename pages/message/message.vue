		...
		<scroll-view class="m-message" :scroll-y="true">
			...
			<view class="notice-item">
				...
				<view class="message-content">
					...
					<text class="introduce solid-bottom">虽然做了一件好事，但很有可能因此招来他人的无端猜测，例如被质疑是否藏有其他利己动机等，乃至谴责。即便如此，还是要做好事。</text>
					<view class="bot b-t">
						<text>查看详情</text>
			...
			<view class="notice-item">
				...
				<view class="message-content">
					...
					<text class="introduce solid-bottom">新品上市全场2折起，新品上市全场2折起，新品上市全场2折起，新品上市全场2折起，新品上市全场2折起</text>
					<view class="bot b-t">
						<text>查看详情</text>
						<text class="cuIcon-right"></text>
					</view>
